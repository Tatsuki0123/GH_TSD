...
namespace TSD_API_ver101_ISlab
{
    public class Get_Instance : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("List_ISlab", "List_ISlab", "this is List of ISlab", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.Structure.ISlab> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_ISlab.Get_ISlabItem_output.GetOutput(input_1);
            }
            else
            {
        ...
        {
            get { return new Guid("BABF5997-4A68-4D18-AA3E-7F9497D767DD"); }
        }
    }
}