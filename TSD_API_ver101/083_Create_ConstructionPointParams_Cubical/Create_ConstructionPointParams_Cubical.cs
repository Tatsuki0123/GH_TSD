...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Create_ConstructionPointParams_Cubical", "C_ConstructionPointParams_Cubical",
            "Creating the ConstructionPointParams cubical version",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Z Coordinate", "Z", "this is Z coordinate", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            TSD.API.Remoting.Structure.Create.CubicalPointParams output = null;
            ...
            if (/*input_1 != null*/ activate == true)
            {
                ...
                output = TSD_API_ver101_Create_ConstructionPointParams_Cubical.Create_PointLoadParamsCreate_output.CreateConstructionPointParamsCubical(input_2,input_3,input_4);
                output_1 = "Succeeded";
            }
            else
            {
        ...
        {
            get { return new Guid("4A76DB05-B7D5-44BA-AC81-08B1AD806763"); }
        }
    }
}