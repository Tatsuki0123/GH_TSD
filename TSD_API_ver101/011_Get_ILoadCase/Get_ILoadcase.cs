...
namespace TSD_API_ver101_ILoadcase
{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Get_ILoadcase", "G_ILc",
            "Getting the ILoadcase",
        ...
        {
            pManager.AddGenericParameter("List_ILoadcase", "List_ILc", "this is List of ILoadcase", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.Loading.ILoadcase> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_ILoadcase.Get_IMember_output.GetILoadcase(input_1);
            }
            else
            {
        ...
        {
            get { return new Guid("65AB5BDD-4EA6-4AF4-A0DC-B05AC9FB5983"); }
        }
    }
}