...

{
    public class Get_Instance : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("IMember", "IMember", "this is IMember", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            TSD.API.Remoting.Structure.IMember output = null;
            string output_1 = "Processing or not started";

            if (input_1 != null && input_2 != null && activate == true)
            {

                output = TSD_API_ver101_Create_IMember.Create_IMember_output.CreateIMember(input_1, input_2);
                output_1 = "Succeeded";
            }
            else
            {
        ...
        {
            get { return new Guid("68CFCBEC-38CA-4FCA-9DAB-9B6146D23645"); }
        }
    }
}