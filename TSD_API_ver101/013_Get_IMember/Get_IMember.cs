...
namespace TSD_API_ver101_IMember
{
    public class Get_Instance : GH_Component
    {
        ...
        {
            pManager.AddGenericParameter("List_IMember", "List_IMember", "this is List of IMember", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.Structure.IMember> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_IMember.Get_IConstructionPOint_output.GetIMember(input_1);
            }
            else
            {
        ...
        {
            get { return new Guid("9123B46B-72AA-4E17-B03A-3B48FC2FF910"); }
        }
    }
}