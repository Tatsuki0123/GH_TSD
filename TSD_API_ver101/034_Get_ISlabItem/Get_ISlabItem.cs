...
namespace TSD_API_ver101_ISlabItem
{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Get_ISlabItem", "G_ISlabItem",
            "Getting the ISlabItem",
        ...
        {
            pManager.AddGenericParameter("List_ISlabItem", "List_ISlabItem", "this is List of ISlabItem", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.Structure.ISlabItem> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_ISlabItem.Get_ISlabItem_output.GetOutput(input_1);
            }
            else
            {
        ...
        {
            get { return new Guid("01E6CFD1-FF0D-419F-898D-7DE130584B7E"); }
        }
    }
}