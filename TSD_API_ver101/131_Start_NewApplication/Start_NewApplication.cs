...
namespace TSD_API_ver101_Start_NewApplication
{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Start_NewApplication", "Start_NewApplication",
            "Start_NewApplication",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (Active_status)
            {
                output_tsdInstance = TSD_API_ver101_Start_NewApplication.Save_IDocument_Output.StartNewApplication();
            }
            else
            {
        ...
        {
            get { return new Guid("0B438904-AACE-462A-A144-D9A5D2331034"); }
        }
