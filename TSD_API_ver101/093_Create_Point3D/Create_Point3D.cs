...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Create_Point3D", "C_Point3D",
            "Creating the Point3D",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("Z", "Z", "Input Z coordinate", GH_ParamAccess.item);
        ...
        {
            pManager.AddGenericParameter("Point3D", "Point3D", "this is Point3D", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            TSD.API.Remoting.Geometry.Point3D output = new Point3D();
            ...
            if (DA.GetData(0, ref input_1) == true && DA.GetData(1, ref input_2) == true)
            {
                ...
                output = TSD_API_ver101_Create_Point3D.Create_Point3D_output.CreatePoint3D(input_1, input_2,input_3);
            }
            else
            {
        ...
        {
            get { return new Guid("C70934E0-F67F-4FD2-BBD2-113F52543267"); }
        }
    }
}