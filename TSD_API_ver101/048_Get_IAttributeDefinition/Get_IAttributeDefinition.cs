...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Get_IAttributeDefinition", "G_IAttributeDefinition",
            "Getting the IAttributeDefinition",
        ...
        {
            pManager.AddGenericParameter("List_IAttributeDefinition", "List_IAttributeDefinition", "this is List of IAttributeDefinition", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.UserDefinedAttributes.IAttributeDefinition> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_IAttributeDefinition.Get_IAttributeDefinition_output.GetIAttributeDefinition(input_1,input_2);
            }
            else
            {
        ...
        {
            get { return new Guid("CA3EE40B-CDD6-404C-8A9E-B5852953C298"); }
        }
    }
}