...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Create_Entity_General", "C_Entity_General",
            "Creating the Entity Generally",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddGenericParameter("EntityParams", "EntityParams", "this is EntityParams", GH_ParamAccess.item);
        ...
        {
            pManager.AddGenericParameter("IEntity", "IEntity", "this is IEntity", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            TSD.API.Remoting.Common.IEntity output = null;
            string output_1 = "Processing or not started";

            if (input_1 != null && input_2 != null && activate == true)
            {

                output = TSD_API_ver101_Create_Entity_General.Create_IEntity_output.CreateIEntityGeneral(input_1, input_2);
                output_1 = "Succeeded";
            }
            else
            {
        ...
        {
            get { return new Guid("3542C549-B3B0-4A38-A9F8-F5910653EB91"); }
        }
    }
}