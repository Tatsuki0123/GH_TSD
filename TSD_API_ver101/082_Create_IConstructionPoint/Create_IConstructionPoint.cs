...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Create_IConstructionPoint", "C_IConstructionPoint",
            "Creating the IConstructionPoint",
        ...
        {
            pManager.AddGenericParameter("IConstructionPoint", "IConstructionPoint", "this is IConstructionPoint", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            ConstructionPointParams input_2 = null;
            bool activate = false;
            ...
            TSD.API.Remoting.Structure.IConstructionPoint output = null;
            string output_1 = "Processing or not started";

            if (input_1 != null && input_2 != null && activate == true)
            {

                output = TSD_API_ver101_Create_IConstructionPoint.Create_IEntity_output.CreateIConstructionPoint(input_1, input_2);
                output_1 = "Succeeded";
            }
            else
            {
        ...
        {
            get { return new Guid("F6E8048E-055C-4F6A-B9A3-82A975AFF479"); }
        }
    }
}