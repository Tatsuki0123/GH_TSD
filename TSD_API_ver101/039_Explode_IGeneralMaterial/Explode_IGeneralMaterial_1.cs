...
namespace TSD_API_ver101_IGeneralMaterial_Explode
{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Explode_IGeneralMaterial_1", "E_IGeneralMaterial_1",
            "Exploding the IGeneralMaterial ver1",
        ...
        {
            pManager.AddGenericParameter("IGeneralMaterial", "IGeneralMaterial", "Input IGeneralMaterial", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            TSD.API.Remoting.Materials.IGeneralMaterial input_1 = null;
            ...
            DA.SetData(7, output_thermalExpansionCoefficient);
            DA.SetData(8, output_type);
        }
        ...
        {
            get { return new Guid("9175D38F-028A-473E-B06A-1703F76B0ABB"); }
        }
    }
}
