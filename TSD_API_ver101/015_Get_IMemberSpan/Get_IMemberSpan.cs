...

{
    public class Get_Instance : GH_Component
    {
        ...
        /// </summary>
        public Get_Instance()
          : base("Get_IMemberSpan", "G_IMemSp",
            "Getting the IMemberSpan",
        ...
        {
            pManager.AddGenericParameter("List_IMemberSpan", "List_IMemberSpan", "this is List of IMemberSpan", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            List<TSD.API.Remoting.Structure.IMemberSpan> output_list = null;

            if (input_1 != null)
            {
                output_list = TSD_API_ver101_IMemberSpan.Get_RigidZone_output.GetIMemberSpan(input_1);
            }
            else
            {
        ...
        {
            get { return new Guid("327768CB-9F24-4B4E-8C51-CA992DB35BB2"); }
        }
    }
}